Internship Progress Report: Week 1 Project Title: Console-Based Expense Tracker Application
Domain: Core Java Development
Milestone: Java Fundamentals, OOP Concepts & Git/GitHub Repository Setup

1.Summary & Objective Week 1 was dedicated to mastering Core Java programming fundamentals, understanding Object-Oriented Programming (OOP) design patterns, set up the VS Code and downloaded JDK
...
Project Requirements & Architecture Analysis
...
Key Milestones Completed in Week 1
Completed Core Java language fundamentals and OOP principles.
Initialized the project workspace and repository structure.
Configured Git version control and established the GitHub repository.
Finalized the architectural design and functional specifications for the Expense Tracker.
